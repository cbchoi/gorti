...
- lookahead: `1`
- maximum validation attempts: `1`

Result:

- reference IEEE 1516-2010 RTI Java process: pass
...
- verification decision: `complete` after one iteration

Performance snapshot:

| Metric | reference RTI | gorti | Unit |
|---|---:|---:|---|
...
Detailed artifacts remain in the ignored local output directory.

## Claim-grade paired reference RTI/Go result

The previous one reference-RTI run versus twenty-Go-run table is superseded. The final
...
- accounting: reference RTI 4,000/4,000, Go 4,000/4,000
...
| Metric | reference RTI median | Go median | paired Go/reference RTI | paired 95% CI |
|---|---:|---:|---:|---:|
...
gorti is reference-RTI-class on the completed-delivery median and faster for update
...
attested as persistent; the external reference RTI endpoint PID and start time are not
...
The synchronous interaction caller boundary remains about 22% behind reference RTI.
