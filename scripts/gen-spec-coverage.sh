#!/usr/bin/env bash
# scripts/gen-spec-coverage.sh — generate the DLC specification coverage matrix.
#
# The matrix complements engineering/specifications/current/STD.md.
...
#
# READ-ONLY mode (default): writes engineering/verification/dlc-spec-coverage.md.
...
OUT="engineering/verification/dlc-spec-coverage.md"
CHECK_MODE=0
...
This matrix complements \`engineering/specifications/current/STD.md\`. A blank row means the corresponding specification section has no mapped fixture.
