"""CI gate: strict typing for shipped packages and clean lint across pysdk/.
...
def test_mypy_strict_clean() -> None:
    """The shipped Python packages pass mypy strict mode."""
    result = subprocess.run(  # noqa: S603 — argv built from sys.executable + literals
        [
            ...
            "mypy",
            "--strict",
            str(PYSDK_ROOT / "rti1516e"),
            str(PYSDK_ROOT / "pyjevsim_bridge"),
        ],
        capture_output=True,
        text=True,
        check=False,
