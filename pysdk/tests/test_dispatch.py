...
Spec-level conformance lives under ``tests/spec/m4/``.
This file exercises the dispatcher's input-validation branches and any
implementation-internal helpers that aren't reachable from the conformance vectors
alone, per the M4 dispatch plan §6 hard rule on component-owned tests.
"""
