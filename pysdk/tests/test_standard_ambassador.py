...
Spec-level surface checks live under ``tests/spec/m4/`` (orchestrator-
frozen). This file exercises the ambassador's actual delegation into
...
# Spec-test-only fake; agent-owned tests may consume it the same way.
