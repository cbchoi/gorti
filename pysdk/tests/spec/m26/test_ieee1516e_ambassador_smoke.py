"""M26 Phase G — IEEE 1516 ambassador-surface smoke federate end-to-end.

Runs examples/ieee1516e-ambassador-smoke/smoke_federate.py against a live
rtid subprocess. Verifies that a federate written using ONLY the
IEEE 1516 service-style Rti1516eAmbassador methods (no reach-around into
...
"verify gorti matches IEEE 1516-observable semantics" task — the smoke is the
...
def test_spec_m26_ieee1516e_ambassador_smoke() -> None:
    """examples/ieee1516e-ambassador-smoke/smoke_federate.py runs end-to-end."""
