...
def test_spec_m4_select_preserves_pyjevsim_order(stub_coupled) -> None:  # type: ignore[no-untyped-def]
    ...
    # first. The stub's get_select_order convention (when Agent C wires
    # it on StubCoupledModel) should return ports alphabetically; thus
    ...
    # no duplicates). Agent C's TASK-071 implementation will refine the
