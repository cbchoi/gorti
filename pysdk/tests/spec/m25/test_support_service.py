...
upper_bound 1000), then exercises the IEEE 1516 service-style handle/name lookups
...
def test_spec_m25_support_service_end_to_end() -> None:
    """IEEE 1516 service-style handle/name lookups round-trip through the wire."""
