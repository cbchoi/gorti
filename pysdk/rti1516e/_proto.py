...
This is Agent C's iterable copy of the canonical ``py-codegen`` Make target
in the repo-root ``Makefile``. It exists so this sub-tree can iterate on
codegen without touching the orchestrator-frozen root Makefile. The two
implementations must remain logically equivalent.
