...
var ErrNotImplemented = errors.New("sync: not implemented ( M8 deliverable)")
...
// stable stub signature; renaming would break the M8
// contract.
//
...
// variants (frozen contract); production-grade WAL for sync
...
// method (M37); the frozen core.SyncCoordinator method keeps
...
func (m *Manager) register(
	...
	// (reference_rti ordering: registrationSucceeded → announce). M37.
	if registrant != nil {
...
// duck-types for this richer method (M37); the frozen
