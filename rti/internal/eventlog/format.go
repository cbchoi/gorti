...
func EncodeHeader(buf []byte, hdr core.EventLogHeader) error {
	...
	binary.LittleEndian.PutUint64(buf[offCreatedAtNs:offCreatedAtNs+8], hdr.CreatedAtNs)
...
func DecodeHeader(buf []byte) (core.EventLogHeader, error) {
	...
	hdr.CreatedAtNs = binary.LittleEndian.Uint64(buf[offCreatedAtNs : offCreatedAtNs+8])
