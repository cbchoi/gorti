...
// left empty. M37 adds the federate NAME (§4.26 carries the
...
// (§4.25 success half). Targets the REQUESTING federate only. M37.
...
// (§4.25 failure half). Targets the REQUESTING federate only. M37.
...
// BEFORE the per-federate initiateFederateRestore events. M37.
