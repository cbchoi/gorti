...
//
// M12 W1 exposes the cut-2 sync.Manager through gRPC.
//
...
// production *sync.Manager exposes (M37): it carries the
...
// production *sync.Manager exposes (M37): it carries the §4.14
