...
//
// Wiring choice (, M8 W1): ownership.Manager owns its own state
...
//
// Wiring choice (, M8 W1): the M8 ownership.Manager exposes a
...
//
// Wiring choice (, M8 W1): no Subscribers resolver — fan-out
