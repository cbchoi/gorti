...
// produces a Result with the documented schema. Agent A turns this green
// in TASK-079 by implementing perf.New + perf.Manager.RunBaseline.
//
...
// for the full 10s each and records numbers in agent-a.md.
//
...
// (TASK-084 Agent B reads docs/reports/M5/agent-a.md which was produced
// by TASK-080's run of this Result).
//
