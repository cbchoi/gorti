// Package m12spec contains the orchestrator-frozen specification tests
...
// (orchestrator pre-work), wire gRPC handlers in
...
// dispatched. Agent A turns the Go-side green; Agent C handles the
// Python SDK side under pysdk/tests/spec/m12/.
package m12spec
