...
// TestSpec_M7_TAR_NotImplementedYet began as a pre-dispatch sentinel.
// Now that TAR is implemented (M7 W1), the assertion
...
//
// SCAFFOLD — turns from a skip into a real assertion when TAR lands.
//
