...
//
// IMPORTANT: the public API surface declared here — Codec and
...
// ErrNotImplemented is returned by functions that are still stubs.
var ErrNotImplemented = errors.New("encoding: not implemented ( M1 deliverable)")
...
//
//   - a model.DataType (the production RTI path);
