...
//
// Pitch ref: ~/prti1516e/api/cpp/HLA_1516-2010/RTI/time/HLAfloat64Time.h
...
// Pitch's concrete is constructible from a bare double (federate code does
...
// HLAfloat64Time& operator=(double)  per Pitch — federate code does `t = 1.0`.
