...
//
// reference_rti only ships `EncoderException` in this header (line 23 of the reference
// EncodingExceptions.h). DecoderException is mentioned in the M31 brief but is
// not in the IEEE 1516 service surface — locking only EncoderException keeps this TU
// faithful to the IEEE 1516.1-2010 API contract.
