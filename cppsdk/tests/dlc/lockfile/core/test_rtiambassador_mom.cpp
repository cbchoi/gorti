...
// mom_federation_lifecycle drives MOM through standard
...
//         `RTI/RTIambassador.h` stub omitting these methods.
//        Once the stub lands, federates that call the M17 helpers
