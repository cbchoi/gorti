...
//        variant `createFederationExecutionWithMIM` (Pitch RTIambassador.h:65-106).
...
//      (catalogue 3.7, Pitch RTIambassador.h:118-121).
static_assert(std::is_same_v<
...
//      (catalogue 3.8, Pitch RTIambassador.h:124-158).
...
// §4.16 requestFederationSave — 2 overloads (catalogue 3.12, Pitch RTIambassador.h:208-220).
static_assert(std::is_same_v<
