...
// gorti's `gortiAddress=127.0.0.1:<port>` implementation-defined
// local-settings option for IEEE 1516.1-2010 §10.6.1 connect().
//
...
class RtidRunner {
 public:
  ...
  // gorti implementation-defined local settings for §10.6.1 connect().
  std::string gortiAddress() const {
    return "gortiAddress=127.0.0.1:" + std::to_string(port_);
  }
