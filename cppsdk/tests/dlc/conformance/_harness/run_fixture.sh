...
#   port 8989            # optional directive: fixture needs this port
#
# Semantics:
...
#   * the whole run is serialized under flock on /tmp/gorti-rtid-8989.lock
...
LOCK_FILE=/tmp/gorti-rtid-8989.lock
