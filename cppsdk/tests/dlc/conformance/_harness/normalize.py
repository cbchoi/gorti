...
# parity diff (canon(gorti_log) == canon(pitch_log)).
#
# Test PASS contract:
#   gorti-only: canonicalize(gorti_log) == load_golden(expected.*.log)
#   parity   : canonicalize(gorti_log) == canonicalize(pitch_log)
#
# Pin: docs/DLC_COMPLIANCE_PROGRAM.md §5.3 (Pitch 5.5.10 build 9905).
