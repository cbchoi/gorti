// M39 Agent HB — bridge-error → DLC spec-exception translation (impl).
//
// See BridgeErrorTranslation.h for the pipeline contract. History: the
// prefix vocabulary began as the eight M17 typed exceptions (M34 Agent
// AA), grew detail sniffs at M37 (Agent EC-3 / EE), and became the full
