// M34 — DLCFederateAmbassadorBridge.
//
...
//
// INSTALLATION. DLCRTIambassadorImpl::connect() installs this bridge as
// `m17_fed_ref_` for the M17 implementation.
//
...
// ===== FR-DLC-14 — callback re-entrancy witness (M36) =====
//
...
class DLCFederateAmbassadorBridge : public rti1516e_m17::FederateAmbassador {
 public:
  ...
  // §4.15 — M37: the failed-set-carrying M17 slot (M37
  ...
  // ===== §4.12 sync-point registration acks (M37) =====
  ...
  // ===== §5.10-13 declaration advisories (M37) =====
  ...
  // ===== §6.17-18 DDM scope advisories (M37) =====
  ...
  // attributes; nothing was queued. M37 (real wire — replaces
  ...
  // §4.26 — the name-carrying 3-arg M17 slot (M37 wire); the
  // save-time federate name forwards for real. M37.
  void initiateFederateRestore(
      const std::string& label,
  ...
  // reason string (spec carries no reason on §4.25). M37.
  ...
  // §4.26 — a federation restore is beginning. M37.
