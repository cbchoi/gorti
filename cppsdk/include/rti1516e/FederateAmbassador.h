...
//
// Mirrors reference_rti's `rti1516e::FederateAmbassador`. Federate code subclasses
...
class FederateAmbassador {
 public:
  ...
  // echoes the deleter's user-supplied tag. M36.
  ...
  // fresh values for ``attributes``. M36.
  ...
  // rti.v1.SyncPointFailureReason. M37.
  ...
  // accepted; expect the §4.13 announce next. M37.
  ...
  // no further reflects until they re-enter. M37.
  ...
  // ``tag`` echoes the acquirer's user-supplied tag. M37.
  ...
  // is the human-readable rejection cause. M37.
