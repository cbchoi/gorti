"""Two-federate gorti implementation of the IEEE 1516 Evolved Chat contract."""
...
def run_chat_scenario(
    ...
    *,
    ...
    if publisher_thread.is_alive() or subscriber_thread.is_alive():
        raise TimeoutError("IEEE 1516 Chat parity scenario did not terminate")
    if errors:
        raise RuntimeError(
            f"IEEE 1516 Chat parity scenario failed; trace={trace.snapshot()!r}"
        ) from errors[0]
