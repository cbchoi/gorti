...
# the bare-name shadow collision that hits when pytest collects
# multiple examples/pyjevsim*/runner.py files in one invocation.
import importlib.util as _il  # noqa: E402
_spec = _il.spec_from_file_location("_pyjevsim_relay_runner", _HERE / "runner.py")
_runner = _il.module_from_spec(_spec)
sys.modules.setdefault("_pyjevsim_relay_runner", _runner)
