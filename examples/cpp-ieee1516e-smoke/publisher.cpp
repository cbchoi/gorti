// examples/cpp-ieee1516e-smoke/publisher — C++ federate that publishes
...
//   --federation  federation name (default: cpp-ieee1516e-smoke)
...
int main(int argc, char** argv) {
  ...
  std::string federation = "cpp-ieee1516e-smoke";
